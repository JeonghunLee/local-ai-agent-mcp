...
- [mcp/mcp-server.md](../mcp/mcp-server.md) — MCP 서버 설정
- [experiments/wsl2-setup.md](../experiments/wsl2-setup.md) — WSL2 설치 실험
- [experiments/ollama-setup.md](../experiments/ollama-setup.md) — Ollama 설치 실험
